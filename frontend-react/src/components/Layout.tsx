  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar with logout */}
        <div className="bg-white shadow-sm border-b border-gray-200 px-4 py-3 flex justify-between items-center" style={{ paddingLeft: '3.5rem' }}>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">Thiyagarajan Kamalakannan</p>
